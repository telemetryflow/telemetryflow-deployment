...
| ------------------------------------ | --------------------- | --------------------------- |
| `global.namespace`                   | `observability`       | Kubernetes namespace        |
...
| `tfoAgent.image.tag`                 | `1.3.2`                   | Agent version                    |
...
| `tfoCollector.image.tag`                                     | `1.3.0`                           | Collector version       |
...
| `tfoBackend.image.tag`                           | `2.5.8`                                | Backend version      |
