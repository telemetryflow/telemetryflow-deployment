...
flowchart TD
    ...
    ROLE_DISPATCH -->|node| REDIS["tfo-valkey container"]
...
| `tfo-postgres`     | Deploys PostgreSQL container                                          | Image: `postgres:18-alpine`, Port: 5432                             |
| `tfo-clickhouse`   | Deploys ClickHouse container                                          | Image: `clickhouse/clickhouse-server:24-alpine`                     |
| `tfo-valkey`       | Deploys Valkey container                                               | Image: `valkey/valkey:9-alpine`                                             |
