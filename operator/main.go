...
func init() {
	...
	utilruntime.Must(telemetryflowv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	if err = (&controller.TelemetryFlowReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TelemetryFlow")
		os.Exit(1)
	}
