module github.com/telemetryflow/telemetryflow-operator
...
require (
	...
	// -------------------------------------------------------------------------
	// Kubernetes API
	// See: https://github.com/kubernetes/kubernetes
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	sigs.k8s.io/controller-runtime v0.20.4 // Kubernetes controller runtime
)
...
require (
	...
	sigs.k8s.io/yaml v1.4.2 // indirect
)
