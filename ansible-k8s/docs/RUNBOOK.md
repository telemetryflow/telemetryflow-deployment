...
helm rollback telemetryflow <REVISION> -n observability
```
...
1. Check Helm release status: `helm status telemetryflow -n observability`
2. Review pod events: `kubectl describe pod <pod> -n observability`
3. Check values: `helm get values telemetryflow -n observability --all`
