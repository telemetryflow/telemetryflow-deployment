...
| Module  | Resource                                                                                              |
| ------- | ----------------------------------------------------------------------------------------------------- |
| network | VPC, public subnet a, private subnet a, IGW, public route table                                         |
| network | _(optional)_ NAT GW + EIP + private route table (a -> NAT)                                              |
...
| `enable_nat`              | `false`                                               | `true` creates NAT GW serving private a     |
