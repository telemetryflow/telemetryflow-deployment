...
#    - Common Tags
#    - Module Network (VPC / Subnet a / IGW / NAT) - single-AZ
...
# --------------------------------------------------------------------------
#  Reuse Module: Network (VPC + Subnet a + IGW + optional NAT)
# --------------------------------------------------------------------------
module "network" {
...
module "compute" {
  ...
  # To spread across AZs, add b/c subnets and split the pools.
